-- Production onboarding repair for Work Hat.
--
-- Run this once in the Supabase SQL Editor for the project used by
-- NEXT_PUBLIC_SUPABASE_URL. It installs/repairs the first-user bootstrap RPC
-- and restores service_role privileges needed by trusted Next.js API routes.
...
grant execute on function public.current_user_can_manage_settings() to authenticated, service_role;
