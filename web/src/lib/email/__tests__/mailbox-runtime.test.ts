import { getMailTransportSettings, providerNeedsAppPasswordHint } from "@/lib/email/adapters/provider-config";
import { getMailboxAdapter } from "@/lib/email/adapters";
import { classifyMailboxError } from "@/lib/email/adapters/errors";
import { assertGoogleOAuthConfig, buildGmailAuthUrl, getGoogleRedirectUri, GMAIL_IMPORT_QUERY, GMAIL_SCOPES } from "@/lib/email/google";
import { buildStoredDiagnostics, isActiveMailboxStatus, normalizeMailboxStatus } from "@/lib/email/mailbox-status";
