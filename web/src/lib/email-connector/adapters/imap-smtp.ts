...
import { resolveMailboxChannel } from "@/lib/email-connector/mailbox-channels";
import { buildStoredDiagnostics, isActiveMailboxStatus } from "@/lib/email-connector/mailbox-status";
import { processInboundEmail, type InboundEmailAddress, type NormalizedInboundEmail } from "@/lib/email-connector/inbound";
import {
...
import { classifyMailboxError, MailboxAdapterError } from "@/lib/email-connector/adapters/errors";
import type {
  AdapterDiagnostics,
  FetchInboundResult,
  MailboxAdapter,
