...
export function Sidebar() {
  ...
  if (collapsed) {
    return (
      <aside
        ...
        data-collapsed="true"
        className="relative flex h-full w-[18px] shrink-0 border-r border-[var(--line)] bg-[var(--panel)]"
      >
        <button
          type="button"
          ...
          className="absolute left-1 top-1/2 z-20 flex h-16 w-5 -translate-y-1/2 items-center justify-center rounded-full border border-[var(--line-strong)] bg-[var(--panel-strong)] text-sm text-[var(--muted)] shadow-[0_10px_30px_rgba(0,0,0,0.22)] transition-colors hover:border-[var(--moss)] hover:text-[var(--foreground)]"
  ...
  return (
    <aside
      ...
      className="grain-panel relative flex h-full w-[228px] shrink-0 flex-col border-r border-[var(--line)] transition-[width] duration-200"
    >
      <button
        type="button"
        ...
        className="absolute right-[-11px] top-1/2 z-20 flex h-16 w-5 -translate-y-1/2 items-center justify-center rounded-full border border-[var(--line-strong)] bg-[var(--panel-strong)] text-sm text-[var(--muted)] shadow-[0_10px_30px_rgba(0,0,0,0.22)] transition-colors hover:border-[var(--moss)] hover:text-[var(--foreground)]"
      ...
      <div className="mt-auto shrink-0 border-t border-[var(--line)] px-4 py-4">
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            title="Sign out"
            className="shrink-0 rounded-lg p-1 text-[var(--muted)] transition-colors hover:bg-[var(--sage)] hover:text-[var(--foreground)]"
          >
