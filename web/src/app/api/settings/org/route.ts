...
export async function PATCH(req: NextRequest) {
  ...
  if (typeof body.supportEmail === "string") channelUpdates.support_email = body.supportEmail;
  if (typeof body.fromName === "string") channelUpdates.from_name = body.fromName;
  if (typeof body.timezone === "string") channelUpdates.timezone = body.timezone;
