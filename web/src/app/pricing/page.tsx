...
const plans = [
  {
    ...
    features: [
      ...
      "AI draft generation (50 drafts / month)",
      "Edit capture + basic analysis",
  ...
  },
  {
    id: "scale",
    name: "Scale",
    tagline: "For ops-driven companies",
    monthlyPrice: 149,
    annualPrice: 119,
    priceLabel: "$149",
    ...
    features: [
      ...
      "Multi-channel inbound (email + API)",
      "Team + org management",
      "QA review queue + workflows",
      "Dedicated Slack support",
      "Custom AI model configuration",
      "Usage analytics + billing export",
    ],
    missing: [],
  },
];
...
const faqs = [
  {
    ...
    a: "A conversation is one inbound email thread, regardless of how many messages it contains. Outbound notes, AI drafts, and sent replies within a thread do not count separately.",
  },
  {
  ...
  },
  {
    ...
    a: "Every time an agent edits an AI draft and sends a reply, Work Hat runs a 3-step pipeline: a word-level diff, a heuristic classifier (detecting tone fixes, policy gaps, factual errors, etc.), and an LLM verification pass. The result is stored so you can track AI improvement over time.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes — Pro and Scale both include a 14-day free trial with full access. No credit card is required to start the trial.",
  },
  {
    q: "Do you offer discounts for annual billing?",
    a: "Yes — annual billing saves approximately 20% compared to month-to-month pricing on both Pro and Scale.",
  },
];
